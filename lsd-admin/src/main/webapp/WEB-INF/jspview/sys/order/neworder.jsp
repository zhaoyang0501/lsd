 ...
 <input id='formid' type="hidden" >
    <div class="wrapper wrapper-content animated fadeInRight">
      <div class="row">
      			...
      			<div class="input-group">
                                        <input id='open_username' type="text" class="form-control"> <span class="input-group-btn"> <button type="button" onclick="submit_open()" class="btn btn-primary">确定
                                        </button> </span>
                </div>
      			</div>
                ...
                <div class="col-sm-12 b-r">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i>订单</a>
                                </li>
                                            ...
                                            <table class="table table-striped table-hover">
                                                <tbody>
                                                	...
                                                	<tr>
                                                        ...
                                                        <td> <a tager='_blank' href='javascript:void(0)' onclick='fun_additem(${food.id})'>加入订单</a></td>
                                                        <td> </td>
                                                    </tr>
                                                	</c:forEach>
                                ...
                                <div id="tab-2" class="tab-pane">
                                   <form id='_form_check'>
                                    ...
                                    <div class="slimScrollDiv" style="position: relative; width: auto; height: 100%;"><div class="full-height-scroll" style="width: auto; height: 100%;">
                                     ...
                                     <div>
                          	  				<button type="button" onclick="fun_check()" class="btn btn-primary">立即结账  </button>
                       			 	</div>
                                   </div>
   ...
   <script>
    ...
    function fun_docheck(){
    	location.href =  $.common.getContextPath() + "/sys/order/check?formid="+thisid;
    }
    /**执行付款动作*/
    function fun_additem(id){
    	$.ajax({
 		   url:  $.common.getContextPath() + "/sys/order/additem?formid="+thisid+"&foodid="+id,
 		   success: function(msg){
 		     if(msg.code==1){
 		    	toastr.success('加入订单成功');
 		    	$("#cashed").empty();
 		    	$.ajax({
 		  		   url:  $.common.getContextPath() + "/sys/order/precheck?formid="+thisid,
 		  		   success: function(msg){
 		  		     if(msg.code==1){
    ...
    function submit_open(){
    	$.ajax({
    		   type: "POST",
    		   url:  $.common.getContextPath() + "/sys/order/open?userName="+$("#open_username").val(),
    		   success: function(msg){
    		     if(msg.code==1){
    		    	 thisid=msg.datas.id;
    		    	 $("#formid").val(msg.datas.id);
