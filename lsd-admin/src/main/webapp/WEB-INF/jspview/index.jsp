    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="sys/food/index">零食管理</a></li>
                             <li><a class="J_menuItem" href="sys/order/neworder">下单</a></li>
                              <li><a class="J_menuItem" href="sys/seat/formtodo">订单查看</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${pageContext.request.contextPath}/sys/order/neworder" tppabs="${pageContext.request.contextPath}/sys/seat/index" frameborder="0" data-id="tasktodo" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2014-2015 <a href="" tppabs="http://www.zi-han.net/" target="_blank">有问题联系:263608237</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
